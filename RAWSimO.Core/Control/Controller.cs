...
namespace RAWSimO.Core.Control
{
    ...
    public class Controller
    {
        ...
        public Controller(Instance instance)
        {
            ...
            {
                case PathPlanningMethodType.HH: PathManager = new HyperHeuristicsPathManager(instance); break;
        ...
        /// </summary>
        /// <param name="newManager">The new manager.</param>
        public void ExchangePathManager(PathManager newManager)
        {
            Instance.RemoveUpdateable(PathManager);
            PathManager = newManager;
            Instance.AddUpdateable(newManager);
        }
        #region Manager exchange handling

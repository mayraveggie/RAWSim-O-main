...
namespace RAWSimO.Core.Configurations
{
    ...
    public class HyperHeuristicsPathManagerConfiguration : PathPlanningConfiguration
    {
        /// <summary>
        /// Returns the type of the corresponding method this configuration belongs to.
        /// </summary>
        /// <returns>The type of the method.</returns>
        public override PathPlanningMethodType GetMethodType() { return PathPlanningMethodType.HH; }
        /// <summary>
        /// Returns a name identifying the method.
        /// </summary>
        /// <returns>The name of the method.</returns>
        public override string GetMethodName() { if (!string.IsNullOrWhiteSpace(Name)) return Name; return "ppHH"; }

        public HyperHeuristicsPathManagerConfiguration() { }
        /// <summary>
        /// Contructor that generates default values for all fields.
        /// </summary>
        /// <param name="param">Not used.</param>
        public HyperHeuristicsPathManagerConfiguration(DefaultConstructorIdentificationClass param)
        {
            HHPPManagers = new List<Skvp<double, PathPlanningMethodType>>()
            {
                new Skvp<double, PathPlanningMethodType>() { Key = 0.5, Value = PathPlanningMethodType.Dummy },
            };
        }
        ...
        /// </summary>
        public List<Skvp<double, PathPlanningMethodType>> HHPPManagers;
        #endregion
    }
